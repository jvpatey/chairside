-- Group clinics should not get an auto-seeded primary location stub.
-- Locations are added explicitly during group setup.
...
-- Remove address-less group stubs created by earlier bootstrap.
delete from public.clinic_locations l
using public.clinic_organizations o
where l.organization_id = o.id
  and o.account_type = 'group'
  and nullif(trim(l.address_line1), '') is null;
